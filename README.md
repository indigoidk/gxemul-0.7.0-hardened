...
| `<pending>` | Round 78 (#319/#320/#321): ARM rotations the decoder answered by halting — and MVNS, which took its carry from the complement and was wrong in every band |
